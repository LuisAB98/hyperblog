# hyperblog
Un blog increible para el curso de Git &amp; GitHub de Plazi
...
Y como un amable recordatorio: **Este readme.md es un chiste**.  DiseÃ±ado para el ejemplo. Si llegas acÃ¡ NO TE LO TOMES EN SERIO y mejor 